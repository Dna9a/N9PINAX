...
def start_passive_capture(
    ...
    try:
        ...
        _log.warning("scapy unavailable — DHCP passive capture skipped")
        return {}
    ...
    try:
        ...
        _log.warning("DHCP sniff requires CAP_NET_RAW / root")
        return {}
...
def enrich_devices(
    ...
    Args:
        ...
        captured: Résultats de start_passive_capture().
                  Si None, tente une capture passive.
        timeout:  Durée d'écoute si captured est None.
