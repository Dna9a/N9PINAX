...
COMMON_PORTS: dict[int, str] = {
    ...
    8883: "MQTT-TLS",
    5683: "CoAP",
    # ── Bureautique / partage Apple ───────────────────
    548: "AFP",
    88: "Kerberos",
}

# Ports sur lesquels on tente de lire une bannière
BANNER_PORTS: set[int] = {21, 22, 25, 80, 110, 143, 443, 8080, 8443, 8000, 8888}
...
def _grab_banner(
    ...
    try:
        ...
        if port in (80, 8080, 8000, 8888):
            try:
                # Send a HEAD request with a proper Host header so vhosted
                # servers will respond — the previous "Host: target" was
                # rejected by some hardened nginx setups.
                try:
